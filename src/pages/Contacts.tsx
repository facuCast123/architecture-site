...
const Contacts = () => {
  return (
    <section className="grid grid-cols-1 grid-rows-2 items-center mt-10 pb-20 md:h-screen md:flex">
      ...
      <div className="h-2/4 basis-2/3 border border-black [&>*]:h-full md:h-full">
